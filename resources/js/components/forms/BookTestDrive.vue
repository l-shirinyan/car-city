<template>
    <div>
        ...
        <div class="flex flex-row items-center gap-3 my-4">
            <input type="checkbox" v-model="formData.checked"> <span>I accept the <a href="/terms-and-conditions"
                    class="underline">Terms & Conditions</a> and confirm that I’m above the age of 25 and have a valid
    ...
    methods: {
        ...
        async submitForm() {
            ...
            if (typeof grecaptcha !== undefined) {
                ...
                const token = await grecaptcha.execute('6Ld6dr8hAAAAAF9J5fcxNdvJE5fvibl-rhQOJxDX', { action: 'book-test-drive' });
                try {
                    const response = await axios.post('/form/book-test-drive', {
                        ...this.formData,
